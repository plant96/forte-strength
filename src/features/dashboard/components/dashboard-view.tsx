...
/**
 * The client home. One choreography: the greeting rises first, then the lifts card and
 * the two lists follow in a stagger; inside each, rows and numbers take their turn.
 * Two columns from `lg` up, a single stack below it.
 */
export function DashboardView({ firstName, lifts, unit, tools, resources }: DashboardViewProps) {
  return (
    <m.div
